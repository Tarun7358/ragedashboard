...
export const DEFAULT_SECURITY_RULES: Record<string, { enabled: boolean; limit: number; window: number; action: string; recovery: boolean }> = {
  anti_role_grant: { enabled: true, limit: 2, window: 10, action: 'ban', recovery: true },
  anti_role_remove: { enabled: true, limit: 2, window: 10, action: 'ban', recovery: true },
  anti_role_update: { enabled: true, limit: 2, window: 10, action: 'ban', recovery: true },
  anti_role_create: { enabled: true, limit: 2, window: 10, action: 'ban', recovery: true },
  anti_role_delete: { enabled: true, limit: 1, window: 10, action: 'ban', recovery: true },
  anti_channel_create: { enabled: true, limit: 2, window: 10, action: 'ban', recovery: true },
  anti_channel_delete: { enabled: true, limit: 1, window: 10, action: 'ban', recovery: true },
  anti_channel_update: { enabled: true, limit: 2, window: 10, action: 'ban', recovery: true },
  anti_ban: { enabled: true, limit: 2, window: 10, action: 'ban', recovery: true },
  anti_kick: { enabled: true, limit: 2, window: 10, action: 'ban', recovery: true },
  anti_timeout: { enabled: true, limit: 2, window: 10, action: 'ban', recovery: true },
  anti_bot_add: { enabled: true, limit: 1, window: 10, action: 'ban', recovery: true },
  anti_bot_remove: { enabled: true, limit: 1, window: 10, action: 'ban', recovery: true },
  anti_webhook_create: { enabled: true, limit: 1, window: 10, action: 'ban', recovery: true },
  anti_webhook_delete: { enabled: true, limit: 1, window: 10, action: 'ban', recovery: true },
  anti_webhook_update: { enabled: true, limit: 1, window: 10, action: 'ban', recovery: true },
  anti_guild_update: { enabled: true, limit: 1, window: 10, action: 'ban', recovery: true },
  anti_prune: { enabled: true, limit: 1, window: 10, action: 'ban', recovery: true },
  anti_emoji_create: { enabled: true, limit: 2, window: 10, action: 'ban', recovery: true },
  anti_emoji_delete: { enabled: true, limit: 2, window: 10, action: 'ban', recovery: true },
  anti_emoji_update: { enabled: true, limit: 2, window: 10, action: 'ban', recovery: true },
  anti_sticker_create: { enabled: true, limit: 2, window: 10, action: 'ban', recovery: true },
  anti_sticker_delete: { enabled: true, limit: 2, window: 10, action: 'ban', recovery: true },
  anti_sticker_update: { enabled: true, limit: 2, window: 10, action: 'ban', recovery: true },
